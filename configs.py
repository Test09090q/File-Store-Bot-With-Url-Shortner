...
class Config(object):
  ...
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "qtmovies_bot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002187044576"))
  ...
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002187044576"))
